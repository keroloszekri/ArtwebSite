        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeOfArt = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Favourites", x => new { x.UserID, x.ArtID });
                    table.ForeignKey(
                        name: "FK_Favourites_Arts_ArtID",
                        column: x => x.ArtID,
                        principalTable: "Arts",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rates", x => new { x.UserID, x.ArtID });
                    table.ForeignKey(
                        name: "FK_Rates_Arts_ArtID",
                        column: x => x.ArtID,
                        principalTable: "Arts",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
