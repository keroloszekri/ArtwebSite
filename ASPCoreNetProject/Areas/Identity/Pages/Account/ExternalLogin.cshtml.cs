...
namespace ASPCoreNetProject.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            {
                string profilePicture = "MaleProfile.png";
                if(Input.Gender==Gender.Female)
                    profilePicture = "FemaleProfile.png";
                var user = new ApplicationUser { UserName = Input.UserName, Email = Input.Email, FName = Input.FName, LName = Input.LName, Gender = Input.Gender,ProfilePicture=profilePicture };
