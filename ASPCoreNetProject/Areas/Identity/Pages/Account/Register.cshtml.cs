    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    imageurl = "MaleProfile.png";
                }
                else
                {
                    imageurl = "FemaleProfile.png";
                }
                var user = new ApplicationUser { UserName = Input.UserName, FName = Input.FName, LName = Input.LName, Gender = Input.Gender, Email = Input.Email, ProfilePicture = imageurl };
